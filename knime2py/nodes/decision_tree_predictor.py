...
# KNIME factory
DT_PREDICTOR_FACTORY = "org.knime.base.node.mine.decisiontree2.predictor2.DecTreePredictorNodeFactory"


def can_handle(node_type: Optional[str]) -> bool:
    return bool(node_type and node_type.endswith(DT_PREDICTOR_FACTORY))
