# Auto-generated test for KNIME workflow "Example_Date_Issue23"
...
def test_roundtrip_example_date_issue23(output_dir: Path):
    repo_root = Path(__file__).resolve().parents[1]
    knime_proj = repo_root / "tests" / "data" / "Example_Date_Issue23"
    out_dir = output_dir  # provided by conftest.py fixture
    expected_dir = repo_root / "tests" / "data" / "data" / "Example_Date_Issue23"
