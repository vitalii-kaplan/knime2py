# Auto-generated test for KNIME workflow "Example_Duplicates_Issue24"
...
def test_roundtrip_example_duplicates_issue24(output_dir: Path):
    repo_root = Path(__file__).resolve().parents[1]
    knime_proj = repo_root / "tests" / "data" / "Example_Duplicates_Issue24"
    out_dir = output_dir  # provided by conftest.py fixture
    expected_dir = repo_root / "tests" / "data" / "data" / "Example_Duplicates_Issue24"
