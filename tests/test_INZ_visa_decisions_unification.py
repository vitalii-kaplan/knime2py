# Auto-generated test for KNIME workflow "INZ_visa_decisions_unification"
...
def test_roundtrip_inz_visa_decisions_unification(output_dir: Path):
    repo_root = Path(__file__).resolve().parents[1]
    knime_proj = repo_root / "tests" / "data" / "INZ_visa_decisions_unification"
    out_dir = output_dir  # provided by conftest.py fixture
    expected_dir = repo_root / "tests" / "data" / "data" / "INZ_visa_decisions_unification"
