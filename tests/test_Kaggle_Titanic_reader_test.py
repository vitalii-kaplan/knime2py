# Auto-generated test for KNIME workflow "Kaggle_Titanic_reader_test"
...
def test_roundtrip_kaggle_titanic_reader_test(output_dir: Path):
    repo_root = Path(__file__).resolve().parents[1]
    knime_proj = repo_root / "tests" / "data" / "Kaggle_Titanic_reader_test"
    out_dir = output_dir  # provided by conftest.py fixture
    expected_dir = repo_root / "tests" / "data" / "data" / "Kaggle_Titanic_reader_test"
